...
function createCharCodes(column: HTMLParagraphElement) {
...
function setCharCodes(
  column: HTMLParagraphElement,
  codes: string[],
  size: number
) {
...
function createRain(container: HTMLElement, columns: number) {
